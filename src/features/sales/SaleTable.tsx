    ...
    <DataTable
      ...
      toolbar={
        <select
          ...
          className="h-10 rounded-sm bg-[var(--surface)] px-3 text-sm font-medium ring-1 ring-inset ring-[var(--field-border)] focus:outline-none focus:ring-2 focus:ring-brand-500"
        >
