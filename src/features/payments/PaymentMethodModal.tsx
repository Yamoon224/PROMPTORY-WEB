      ...
      <div className="flex flex-col gap-4">
        <div role="tablist" aria-label="Moyen de paiement" className="grid grid-cols-2 gap-2">
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-2 rounded-sm border px-3 py-2.5 text-sm font-semibold transition-colors",
              method === "stripe"
          ...
          <button
            ...
            className={cn(
              "flex items-center justify-center gap-2 rounded-sm border px-3 py-2.5 text-sm font-bold transition-colors",
              method === "paypal"
        ...
        {method === "stripe" ? (
          ...
          <div className="flex flex-col items-center gap-4 rounded-sm bg-[var(--surface-muted)] px-4 py-8 text-center">
            ...
            <button
              ...
              disabled={isPending}
              className="flex h-11 w-full max-w-xs items-center justify-center rounded-sm bg-[#ffc439] text-base font-bold text-[#003087] transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isPending ? (
                "Redirection…"
              ) : (
