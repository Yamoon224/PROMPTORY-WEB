  ...
  return (
    <div className="mx-auto grid max-w-5xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-[1fr_26rem] md:items-center md:py-16">
      <div className="hidden md:block">
        <h1 className="font-display text-4xl leading-[1.1] font-semibold tracking-tight text-[var(--foreground)]">
          Vos meilleurs prompts, enfin valorises.
        </h1>
      ...
      <Card>
        <CardBody className="p-5 sm:p-7">
          ...
          <p className="mb-6 mt-2 text-sm text-[var(--muted)]">{description}</p>
          {children}
        </CardBody>
      </Card>
    </div>
