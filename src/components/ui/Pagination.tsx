      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none rounded-full bg-[var(--surface)] py-1.5 pl-2.5 pr-7 text-xs font-semibold tabular-nums ring-1 ring-inset ring-[var(--field-border)] focus:outline-none focus:ring-2 focus:ring-brand-500"
          >
            {options.map((option) => (
