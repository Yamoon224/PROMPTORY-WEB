    ...
    <header className="no-print sticky top-0 z-20 flex h-16 items-center justify-between gap-3 border-b border-[var(--hairline)] bg-[var(--surface)]/85 px-4 backdrop-blur-md sm:px-6">
      <div className="flex min-w-0 items-center gap-2">
        <button
          ...
          className="rounded-sm p-2 text-zinc-500 hover:bg-zinc-100 md:hidden dark:hover:bg-zinc-800"
        >
        ...
        <button
          ...
          className="hidden rounded-sm p-2 text-zinc-500 hover:bg-zinc-100 md:inline-flex dark:hover:bg-zinc-800"
        >
